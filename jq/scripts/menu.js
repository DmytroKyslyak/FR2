class b_menu{
	...
	hideSubmenu(event){
		...
		let 
			...
			,jqSubmenu  = jqMenuItem.children('.b-submenu')
			;
	...
	createEvents(){
		...
		this.menu.find('.b-menu__item')
			.mouseover(this.showSubmenu.bind(this)) //.bind(this)-чтобы указатели на методы-обработчики событий
			//корректно работали с this при описании событий мы это и пишем.
